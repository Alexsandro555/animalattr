...
{
    private $tableName = 'attribute_boolean_values';
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
          ...
          $table->boolean('value')->default(false)->comment('Значение');
    ...
    public function down()
    {
      Schema::table($this->tableName, function (Blueprint $table) {
        $table->dropForeign('attribute_boolean_values_attribute_id_foreign');
      });
